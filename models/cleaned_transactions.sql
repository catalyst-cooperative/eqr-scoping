SELECT
    ...
    CAST(UPPER(point_of_delivery_balancing_authority) AS VARCHAR) AS point_of_delivery_balancing_authority,
    -- There are ~9000 of these. Low cardinality relative to 200M rows, but it's a
    CAST(UPPER(point_of_delivery_specific_location) AS VARCHAR) AS point_of_delivery_specific_location,
